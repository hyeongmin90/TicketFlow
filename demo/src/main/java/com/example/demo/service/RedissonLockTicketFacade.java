...
import com.example.demo.infra.KafkaEventPublisher;
    ...
    public void reserveTicket(ReserveRequestDto requestDto, String messageId) {
        ...
        try {
            ...
            ReservationSuccessEvent event = ReservationSuccessEvent.builder()
                    ...
                    .reservedAt(responseDto.getReservedAt())
                    .build();
            kafkaEventPublisher.publishPaymentRequest(event);
